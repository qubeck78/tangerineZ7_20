...
#
# Script generated by Vivado on Sat Jan 18 23:15:18 +0100 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : ps2KeyboardFifo.sh
...
#
# Usage        : ps2KeyboardFifo.sh
#                ps2KeyboardFifo.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ps2KeyboardFifo.sh [-reset_run]
#                ps2KeyboardFifo.sh [-reset_log]
#                ps2KeyboardFifo.sh [-help]
#
...
# script info
echo -e "ps2KeyboardFifo.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ps2KeyboardFifo.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_8 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ps2KeyboardFifo xil_defaultlib.ps2KeyboardFifo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ps2KeyboardFifo -key {Behavioral:sim_1:Functional:ps2KeyboardFifo} -tclbatch cmd.tcl -protoinst "protoinst_files/tangerineZ7_20.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ps2KeyboardFifo.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ps2KeyboardFifo.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ps2KeyboardFifo.sh [-help]\n\
Usage: ps2KeyboardFifo.sh [-step]\n\
Usage: ps2KeyboardFifo.sh [-lib_map_path]\n\
Usage: ps2KeyboardFifo.sh [-reset_run]\n\
Usage: ps2KeyboardFifo.sh [-reset_log]\n\
Usage: ps2KeyboardFifo.sh [-keep_index]\n\
Usage: ps2KeyboardFifo.sh [-noclean_files]\n\n\
