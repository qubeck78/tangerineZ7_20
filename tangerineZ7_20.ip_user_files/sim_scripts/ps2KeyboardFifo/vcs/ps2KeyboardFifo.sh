...
#                script (type 'ps2KeyboardFifo.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ps2KeyboardFifo xil_defaultlib.glbl -o ps2KeyboardFifo_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ps2KeyboardFifo_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ps2KeyboardFifo_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ps2KeyboardFifo_simv.daidir vcs_lib c.obj)
