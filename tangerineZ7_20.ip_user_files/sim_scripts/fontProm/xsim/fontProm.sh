...
#
# Script generated by Vivado on Sat Jan 18 12:43:09 +0100 2025
...
simulate()
{
  xsim fontProm -key {Behavioral:sim_1:Functional:fontProm} -tclbatch cmd.tcl -protoinst "protoinst_files/tangerineZ7_20.protoinst" -log simulate.log
}
