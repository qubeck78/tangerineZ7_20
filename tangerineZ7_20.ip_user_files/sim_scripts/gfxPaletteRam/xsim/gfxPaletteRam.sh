...
#
# Script generated by Vivado on Sat Jan 18 12:48:09 +0100 2025
...
# script info
echo -e "gfxPaletteRam.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot gfxPaletteRam xil_defaultlib.gfxPaletteRam xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim gfxPaletteRam -key {Behavioral:sim_1:Functional:gfxPaletteRam} -tclbatch cmd.tcl -protoinst "protoinst_files/tangerineZ7_20.protoinst" -log simulate.log
}
