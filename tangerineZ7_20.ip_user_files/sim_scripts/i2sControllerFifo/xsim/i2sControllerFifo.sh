...
#
# Script generated by Vivado on Fri Jan 24 21:52:45 +0100 2025
...
simulate()
{
  xsim i2sControllerFifo -key {Behavioral:sim_1:Functional:i2sControllerFifo} -tclbatch cmd.tcl -protoinst "protoinst_files/tangerineZ7_20.protoinst" -log simulate.log
}
