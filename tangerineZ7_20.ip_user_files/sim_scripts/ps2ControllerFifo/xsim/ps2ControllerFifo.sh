...
#
# Script generated by Vivado on Wed Jan 29 16:22:36 +0100 2025
...
simulate()
{
  xsim ps2ControllerFifo -key {Behavioral:sim_1:Functional:ps2ControllerFifo} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_2a47.protoinst" -protoinst "protoinst_files/tangerineZ7_20.protoinst" -log simulate.log
}
